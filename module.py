# -*- coding: utf-8 -*-
# @Time     : 2023/11/19 13:23
# @Author   : joker
# @Email    : gryshr@163.com
# @File     : module.py
# @Project  : ElementKG
import numpy as np
from rdkit import Chem
from metric import DataProcess
from utils import *
...
ATOM_FDIM = sum(len(choices) + 1 for choices in ATOM_FEATURES.values()) + 2         # 133 = (100 + 1) + (5+1) * 5
BOND_FDIM = 14
...
class Molecular:
    def __init__(self, smiles: List):
        ...
        # unknown generate 14 random features
        self.hrc2emb = {}
        ...
        if type(smiles) == str:
            ...
            for smile in smiles:
                ...
                mol.append(g)
            self.mol = mol
        # self.mol = MolGraph(smiles, self.smart, self.fg2emb, self.smart2name)
...
class MolGraph:
    ...
    def __init__(self, smiles: str,  smart: List, fg2emb: dict, smart2name: dict) -> None:
        ...
        self.f_fgs = match_fg(mol, smart, fg2emb, smart2name)  # match the functional groups of smiles
